...
#
#export SDC_JAVA_OPTS="-Xmx1g -Xms1g -server -XX:-OmitStackTraceInFastThrow ${SDC_JAVA_OPTS}"

#export SDC_JAVA_OPTS="-Xmx5120m -Xms5120m -server -XX:-OmitStackTraceInFastThrow ${SDC_JAVA_OPTS}"
export SDC_JAVA_OPTS="-Xmx15360m -Xms15360m -Xmn6g -server -XX:-OmitStackTraceInFastThrow ${SDC_JAVA_OPTS}"
...
#export SDC_JAVA8_OPTS=${SDC_JAVA8_OPTS:-"-XX:+UseG1GC -XX:ConcGCThreads=2 -XX:MaxGCPauseMillis=200 -XX:G1HeapRegionSize=8m -Djdk.nio.maxCachedBufferSize=262144"}
